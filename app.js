...
class Member {
	...
	static createMember() {
		const newMember = new Member(firstnameInput.value, lastnameInput.value, phonenumberInput.value);
		return newMember;
	}
}
...
class ProMember extends Member {
	...
	static createProMember() {
		const newProMember = new ProMember(firstnameInput.value, lastnameInput.value, phonenumberInput.value, isProInput.checked);
		return newProMember;
	}
}
